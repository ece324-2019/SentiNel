...
def main(args):
    ...
    train_data, val_data, test_data = data.TabularDataset.splits(path='C:\\Users\\Sonali\\Documents\\GitHub\\SentiNel\\data\\', train='train.tsv',
                                                                 validation='validation.tsv', test='test.tsv',
                                                                 format='tsv',
                                                                 skip_header=True,
                                                                 fields=[('text', TEXT), ('label', LABELS)])
    overfit_data = data.TabularDataset(path='C:\\Users\\Sonali\\Documents\\GitHub\\SentiNel\\data\\overfit.tsv', format='tsv', skip_header=True,
                                       fields=[('text', TEXT), ('label', LABELS)])
    ...
    while (1):
        ...
        if prediction > 0.5:
            ...
            print("Model rnn: Negative", round(float(prediction), 3))
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--model', type=str, default='rnn', help="Model type: baseline,rnn,cnn (Default: baseline)")
